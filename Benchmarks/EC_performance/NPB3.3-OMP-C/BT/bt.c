...
// crucial_data(cuf, "double", PROBLEM_SIZE+1);
// crucial_data(q, "double", PROBLEM_SIZE+1);
 crucial_data(ue, "double", (PROBLEM_SIZE+1)*5);
// crucial_data(buf, "double", (PROBLEM_SIZE+1)*5);
 crucial_data(fjac, "double", (PROBLEM_SIZE+1)*5*5);
 crucial_data(njac, "double", (PROBLEM_SIZE+1)*5*5);
 crucial_data(&lhs, "double", (PROBLEM_SIZE+1)*3*5*5);
