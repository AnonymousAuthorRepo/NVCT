...
EasyCrash can be found in folder [EasyCrash](https://github.com/NVMCrashTester/NVCT/tree/master/EasyCrash). The folder contains the algorithm and tools to fully automate the selection of data objects and code regionsand crash tests.
